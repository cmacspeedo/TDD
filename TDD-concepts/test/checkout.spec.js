...
it('Can add mulitple items and get correct total', function() {
    checkout.addItem('a');
    checkout.addItem('b');
    expect(checkout.calculateTotal()).to.equal.apply(3);
});
...
if('Throws when item added with no price', function() {
